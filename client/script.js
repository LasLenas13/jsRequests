...
// const repeatMyParam = () => {
//     let newStr = "Yo!";
//     axios.get(`http://localhost:3000/repeat/${newStr}`).then(result => {
//         let repeatText = document.querySelector("#repeat-text")
//         repeatText = textContent.result.data
//         repeatText.style.display = 'block';
//     }).catch(err => {console.log(err, message, "problem with repeat")})
// }

// let btn = document.querySelector("#repeat-button")
...
// let queryTest = () => {
//     let myQ = "testing, one, two, three"
//     axios.get(`http://localhost:3000/query-test?${myQ}`).then(result => {
//         console.log(result.data)
//     }).catch(err => {console.log(err, message, "problem with Qtest")})
// }

// let qBtn = document.querySelector("#query-button")
// qBtn.addEventListener("click", queryTest)
...
/*
    ...
    1: Send no queries on the URL -- what happened? 
        ...
        The console reads "You sent an empty query!"

    2: Send more than 1 query on the URL -- what happened? 

        It just adds it to the end.........
*/
...
// let queryTest = () => {
//     let myQ = "testing, one, two, three"
//     let myQ2 = "Last Chance"
//     axios.get(`http://localhost:3000/query-test?${myQ}, ${myQ2}`).then(result => {
//         console.log(result.data)
//     }).catch(err => {console.log(err, message, "problem with Qtest")})
// }
...
function createFood (event){
    ...
    let foodInput = document.querySelector('#input-food') 
    let body = {
...
document.querySelector("#add-food").addEventListener("submit", createFood)